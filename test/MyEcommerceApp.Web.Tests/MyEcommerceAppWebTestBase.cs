...
{
    public abstract class MyEcommerceAppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyEcommerceAppWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyEcommerceAppWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyEcommerceAppDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyEcommerceAppDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyEcommerceAppDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyEcommerceAppDbContext, Task<T>> func)
        {
            T result;
