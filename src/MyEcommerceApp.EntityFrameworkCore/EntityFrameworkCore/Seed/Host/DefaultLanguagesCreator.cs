...
namespace MyEcommerceApp.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly MyEcommerceAppDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = MyEcommerceAppConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(MyEcommerceAppDbContext context)
        {
            _context = context;
        }
